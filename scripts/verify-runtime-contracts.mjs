...
const checks = [
  ...
  ['Earth Moon is the next cislunar reference at 384400 km', spaceModel.includes('{ name: "Moon", radiusKm: 1737.4, orbitalRadiusKm: 384400') && celestialBridge.includes('getPlanetMoons("Earth")[0]') && celestialBridge.includes('Earth-centered cislunar reference')],
