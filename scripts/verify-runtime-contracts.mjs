...
const checks = [
  ...
  ['Earth Moon keeps true 384400 km data while cislunar rendering remains readable', spaceModel.includes('{ name: "Moon", radiusKm: 1737.4, orbitalRadiusKm: 384400') && celestialBridge.includes('EARTH_MOON_DISPLAY_ORBIT_M = 60_000_000') && celestialBridge.includes('moonDisplayOrbitRadiusM(parentName, moon)') && celestialBridge.includes('trueOrbitalRadiusKm: moon.orbitalRadiusKm')],
