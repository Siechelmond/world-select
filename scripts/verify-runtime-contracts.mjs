...
const checks = [
  ...
  ['cislunar Moon guide is visible before Solar but Solar Moon orbit still obeys the orbit toggle', celestialBridge.includes('bridge-guide:earth-moon') && celestialBridge.includes('if (!args.showSolarBodies)') && celestialBridge.includes('bridge-orbit:earth-moon') && celestialBridge.includes('if (args.showOrbits && args.showSolarBodies)')],
